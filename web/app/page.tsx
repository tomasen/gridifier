      ...
      <main className="max-w-7xl mx-auto gap-8">
        <section className="p-6 mb-8 space-y-4 w-full">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold flex flex-col md:flex-row items-baseline bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Gridifier
              <p className="text-sm md:ml-4 flex mt-2 md:mt-0 text-gray-600 dark:text-gray-300">
